...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 17, 2025 at 12:32 PM
...
(3, 'lorzanozs@students.nu-lipa.edu.ph', '$2y$10$rGG56y26Sd4pFfdv0R8OmuDAfry67nH428P8sWFn0uGu0sa9PcPkm', 'admin', 'Enrolled', '2025-09-17 09:22:28'),
(4, 'perezjf1@students.nu-lipa.edu.ph', '$2y$10$y.6LCwj8RptGjk/hg50zP.uGSxy5oVCjNZ85taGWF8qSAH5jzwU16', 'student', 'Not Enrolled', '2025-09-17 10:13:42'),
...
INSERT INTO `user_info` (`id`, `user_id`, `firstname`, `middlename`, `lastname`, `mobile`, `nationality`, `sex`, `academic_year`, `academic_term`, `applying_for`, `strand`, `program`, `second_program`, `family_income`, `father_occupation`, `mother_occupation`, `birthplace`, `city`, `province`, `current_address`) VALUES
(1, 3, 'Zabdiel', 'Sionil', 'Lorzano', '09566224636', 'Filipino', 'Male', '2025-2026', '1st Semester', 'Freshman', 'STEM', 'BSCS', 'BSIT', '300,000', 'Military Dentist', 'Office Clerk', 'Tambo', 'Lipa City', 'Batangas', 'Tambo, Lipa City'),
(2, 4, 'Jan Carlo', 'Flores', 'Perez', '09457833290', 'Filipino', 'Male', '2025-2026', '1st Semester', 'Freshman', 'STEM', 'BSTM', 'BSCE', '800,000', 'Tourist', 'Civil Engineer', 'Batangas', 'Batangas City', 'Batangas', 'Batangas City, Batangas'),
(3, 5, 'Seth Andrei', 'Recomono', 'Dimaano', '09753327815', 'Filipino', 'Male', '2025-2026', '1st Semester', 'Freshman', 'ABM', 'BSA - Marketing', 'BSA - Financial Management', '1,627,000', 'Businessman', 'Businesswoman', 'Granja, Lipa City', 'San Antonio', 'Quezon', 'Pury, San Antonio, Quezon');
